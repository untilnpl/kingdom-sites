 ...
 * Sales contact is Jack; Thomas builds and owns the product work.
 */

export const CONTACT_EMAIL = 'thomas@kingdom-sites.com'
export const CONTACT_MAILTO = `mailto:${CONTACT_EMAIL}`

/** Sales — product ownership conversations, fit, and next steps. */
 ...
 * Jack is included so sales sees every product-ownership enquiry.
 */
export const INQUIRY_TO_EMAILS = [CONTACT_EMAIL, SALES_EMAIL] as const

/** Product-ownership enquiry form (same delivery stack as the old free-look). */
...
export const TEAM: TeamMember[] = [
  {
    id: 'thomas',
    name: 'Thomas Klein',
    role: 'Product ownership & engineering',
    email: CONTACT_EMAIL,
    mailto: CONTACT_MAILTO,
    photoSrc: '/Photos/about.jpg',
    photoAlt: 'Thomas and Monisha',
    blurb:
      'Software engineer and product ownership partner. Mobile-led custom products, systems, and AI — the person who builds and owns the work after launch.',
  },
  {
    id: 'jack',
    name: SALES_NAME,
    ...
    photoAlt: 'Jack',
    blurb:
      'Sales contact for product ownership. Reach out about fit, complexity band, and getting started — he will loop in engineering when it is time to build.',
  },
]
